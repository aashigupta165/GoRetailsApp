            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()){
                    ...
                    case R.id.shop:
                        ...
                        break;
                    case R.id.fruits:
                        startActivity(new Intent(HomeActivity.this, FruitsActivity.class));
                        break;
                    case R.id.vegetables:
                        startActivity(new Intent(HomeActivity.this, VegetablesActivity.class));
                        break;
                    case R.id.grocery:
                        startActivity(new Intent(HomeActivity.this, GroceryActivity.class));
                        break;
                    case R.id.dairy_products:
                        startActivity(new Intent(HomeActivity.this, DairyProductsActivity.class));
                        break;
